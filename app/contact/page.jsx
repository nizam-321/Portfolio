...
export default function ContactPage() {
  return (
    <div className="min-h-screen pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white via-purple-50 to-blue-50">
      ...
      {/* ✅ FORM with Formsubmit.io */}
      <form 
        action="https://formsubmit.co/nizam.frontend@gmail.com" 
        method="POST"
        className="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-md space-y-6"
      >
        {/* Hidden Settings */}
        ...
        <input type="hidden" name="_next" value="https://nizam.frontend@gmail.com/thankyou" /> {/* Optional: apna thank you page link daal sakte ho */}
