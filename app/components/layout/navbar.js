...
//               </Link>
//             ))}
//             {/* <button className="bg-gradient-to-r from-purple-600 to-blue-500 text-white px-6 py-2 rounded-full text-sm font-medium hover:opacity-90 transition-opacity duration-300 hover:shadow-lg">
//               Resume
//             </button>
//           </div> */}
